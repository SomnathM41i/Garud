...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-edit"></i> Edit Jewellery Product
            </h3>
        </div>
            ...
            <form action="{{ route('admin.products.update', $product->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="purity" id="purity"
                        ...
                        value="{{ old('purity', $product->purity) }}" placeholder="e.g. 22K, 18K, 925">
                    @error('purity')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" step="0.01" name="making_charges" id="making_charges"
                            ...
                            value="{{ old('making_charges', $product->making_charges) }}" placeholder="0.00">
