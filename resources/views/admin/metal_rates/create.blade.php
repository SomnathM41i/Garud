...
@section('content')
    ...
    <div class="page-header">
        <h1 class="page-title">Create New Metal Rate</h1>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-coins"></i> Add Metal Rate
            </h3>
        </div>
            ...
            <form action="{{ route('admin.metal-rates.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="purity_percent"
                        ...
                        value="{{ old('purity_percent') }}" placeholder="e.g., 99.9">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="rate_per_gram"
                        class="form-control @error('rate_per_gram') is-invalid @enderror" value="{{ old('rate_per_gram') }}"
